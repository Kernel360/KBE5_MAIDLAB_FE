    ...
    <div className="bg-white rounded-2xl shadow p-6 mb-4 border border-gray-100">
      ...
      <div className="mb-2">
        ...
        <div className="flex flex-col gap-1 mt-2 text-sm">
          <div><span className="text-gray-400 w-12 inline-block">날짜</span> <span className="text-[#4B2E13] font-medium">{formatKoreanDate(reservation.reservationDate)}</span></div>
