...
export const MatchingCard: React.FC<MatchingCardProps> = ({
  ...
  const totalPrice =
    typeof matching.totalPrice === 'string'
  ...
  const serviceTypeLabel =
    SERVICE_TYPE_LABELS[
      matching.serviceType as keyof typeof SERVICE_TYPE_LABELS
    ] || matching.serviceType;

  // 반려동물 표시 개선
  const petDisplay =
    PET_TYPES[matching.pet as keyof typeof PET_TYPES] || matching.pet;
      ...
      <div className="p-5 pb-4">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1 pr-4">
            ...
            <p className="text-sm text-gray-600">{serviceTypeLabel}</p>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-600 flex items-center gap-1 mt-1">
                ...
                {formatTime(matching.startTime)} ~{' '}
                {formatTime(matching.endTime)}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="text-red-500 font-semibold">
                -{formatPrice(platformFee.toString())}
              </span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600">부가세 (10%)</span>
              <span className="text-red-500 font-semibold">
                -{formatPrice(vat.toString())}
              </span>
            </div>
