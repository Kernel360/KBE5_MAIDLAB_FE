...
export const Header: React.FC<HeaderProps> = ({
  ...
  if (variant === 'sub') {
    if (hideBackButton) {
      return (
        <header className="sticky top-0 z-[10000] flex items-center justify-between px-4 py-[18px] border-b bg-white dark:bg-gray-900 dark:border-gray-700 transition-colors">
          <div className="w-10" />
  ...
  return (
    <header className="sticky top-0 z-[10000] bg-white dark:bg-gray-900 px-4 p-3 flex items-center justify-between shadow-sm transition-colors">
      <button
        onClick={handleLogoClick}
