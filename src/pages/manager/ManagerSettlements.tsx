        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {settlements.map((s: any) => (
              <div
                key={s.settlementId}
                className="bg-white rounded-xl shadow p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2 border border-gray-100"
              >
