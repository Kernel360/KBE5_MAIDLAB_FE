...
import type { ReservationDetailResponseDto } from '@/apis/reservation/index.ts';
      ...
      <div className="pt-16 pb-4">
        ...
        <div className="bg-[#FFF8E7] p-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mt-1">예약번호: ANT-20231001-001</p>
          </div>
        </div>
        ...
        <div className="bg-white px-4 py-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1">3시간 (07:30 ~ 10:30)</p>
            </div>
            <div>
              <p className="text-gray-500 text-sm">공간 크기</p>
              <p className="mt-1">{reservation.roomSize}평방미터 / 3방</p>
            </div>
            <div>
              <p className="text-gray-500 text-sm">추가 서비스</p>
              <p className="mt-1">요리 (+1시간)</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="ml-1">{reservation.managerAverageRate.toFixed(1)}</span>
                <span className="text-gray-400 ml-1">(200+)</span>
              </div>
              <p className="text-sm text-gray-500 mt-1">비대면 전자결제 가능</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-2 bg-white px-4 py-5">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500">결제 방법: 카드 결제</p>
          </div>
        </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t">
          <div className="flex gap-3">
            <button className="flex-1 px-4 py-3 border border-red-500 text-red-500 rounded-lg">
              예약 취소
            </button>
