      ...
      <div className="app-container">
        <div className="max-w-4xl mx-auto p-6">
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">정산 정보를 찾을 수 없습니다</h2>
            <p className="text-gray-600 mb-6">요청하신 정산 정보가 존재하지 않거나 삭제되었을 수 있습니다.</p>
            <button
              onClick={() => navigate(-1)}
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">정산 ID: #{settlement.settlementId}</p>
          </div>
        ...
        <div className="mb-6">
          <div className="card bg-gradient-to-r from-orange-50 border-l-4 border-l-orange-500">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">현재 상태</h3>
                <p className="text-gray-600 text-sm">정산 처리 현황을 확인하세요</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card">
            ...
            <div className="card-body space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <span className="text-sm font-medium text-gray-600">정산 ID</span>
                <span className="text-sm text-gray-900 font-mono">#{settlement.settlementId}</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <span className="text-sm font-medium text-gray-600">서비스 유형</span>
                <span className="text-sm text-gray-900 font-medium">{getServiceTypeName(settlement.serviceType)}</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-sm font-medium text-gray-600">상세 서비스</span>
                <span className="text-sm text-gray-900">{settlement.serviceDetailType}</span>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-body space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <span className="text-sm font-medium text-gray-600">플랫폼 수수료</span>
                <span className="text-sm text-red-600 font-medium">-{formatNumber(settlement.platformFee)}원</span>
              </div>
              <div className="flex justify-between items-center py-3 bg-green-50 rounded-lg px-4">
                <span className="text-base font-semibold text-gray-900">정산 금액</span>
              ...
              <div className="text-center py-6">
                {settlement.status === 'PENDING' ? (
                  <div className="text-yellow-600">
                    ...
                    <p className="font-medium">관리자 승인을 기다리고 있습니다</p>
                    <p className="text-sm text-gray-600 mt-1">승인 또는 거부 처리를 진행해주세요</p>
                  </div>
                  ...
                  <div className="text-green-600">
                    ...
                    <p className="text-sm text-gray-600 mt-1">정산 처리가 성공적으로 완료되었습니다</p>
                  </div>
                ) : (
                  <div className="text-red-600">
                    ...
                    <p className="text-sm text-gray-600 mt-1">정산 요청이 거부 처리되었습니다</p>
                  </div>
                )}
              </div>
            </div>
