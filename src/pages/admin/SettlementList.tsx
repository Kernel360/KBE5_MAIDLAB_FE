            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col items-center min-w-[160px]">
                  <div
                    className={`text-lg font-bold transition-opacity duration-200 ${isDateChanging ? 'opacity-50' : 'text-gray-900'}`}
                  >
                    {formatDateForDisplay(startDate)}
                  </div>
                  <div className="text-sm text-gray-500">일요일</div>
                </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="px-3 py-1 bg-blue-100 text-blue-800 text-sm font-medium rounded-full">
                          {getServiceTypeName(
                            settlement.serviceType as ServiceType,
                          )}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${getStatusChipStyles(settlement.status)}`}
                        >
                          {settlement.status}
                        </span>
                      </td>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                  <span className="text-sm text-gray-700 font-medium">
                    {totalElements === 0
                      ? '0-0 / 0'
                      : `${startIndex}-${endIndex} / ${totalElements}`}
                  </span>
