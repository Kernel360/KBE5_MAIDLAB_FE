...
// const AdminManagerDetail = React.lazy(() => import('@/pages/admin/ManagerDetail'));
// const AdminConsumers = React.lazy(() => import('@/pages/admin/Consumers'));
// const AdminConsumerDetail = React.lazy(() => import('@/pages/admin/ConsumerDetail'));
// const AdminReservations = React.lazy(() => import('@/pages/admin/Reservations'));
// const AdminReservationDetail = React.lazy(() => import('@/pages/admin/ReservationDetail'));
...
const AppContent: React.FC = () => {
  ...
  // 초기 로딩 중이면 로딩 스피너 표시
  if (isLoading) {
    return <LoadingSpinner message="앱 초기화 중..." />;
  }

  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <React.Suspense fallback={<LoadingSpinner message="페이지 로딩 중..." />}>
        <Routes>
          {/* 현재 활성화된 공개 라우트 */}
